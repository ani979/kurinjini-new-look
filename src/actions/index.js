...
export const addToCart = (product,qty, size, variant) => (dispatch) => {
    toast.success("Item Added to Cart");
        dispatch(addToCartUnsafe(product, qty, size, variant))
...
export const addToCartUnsafe = (product, qty, size, variant) => ({
