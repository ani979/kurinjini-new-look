		...
		return (
			<div>
                ...
                <div className="title1  section-t-space">
                    <h4>Allow us to help you</h4>
                    <h2 className="title-inner1">What are you looking for?</h2>
                </div>
                <section className="pb-0">
                    <div className="container">
                        <div className="row partition2">
                            <div className="col-md-6">
                                <Link to={`${process.env.PUBLIC_URL}/face-care/collection`}>
                                    <div className="collection-banner p-right text-center">
                                        <img src={`${process.env.PUBLIC_URL}/assets/images/kurinjini-images/FaceCare/faceCare.jpg`} className="img-fluid" alt=""/>
                            ...
                            <div className="col-md-6">
                                <Link to={`${process.env.PUBLIC_URL}/hair-care/collection`}>
                                    <div className="collection-banner p-right text-center">
                                        <img src={`${process.env.PUBLIC_URL}/assets/images/kurinjini-images/hairCare/roots_1.jpg`} className="img-fluid" alt=""/>
                                            <div className="contain-banner">
                                                <div>
                                                    <h2>Hair care</h2>
                                                </div>
