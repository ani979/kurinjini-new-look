        ...
        return (
            <div>
                ...
                <section className="p-0">
                    ...
                    <Link to={`${process.env.PUBLIC_URL}/product/oatmeal-soap`}>
                        <div>
                            <div className="home home23 text-center">
                                        ...
                                        <div className="col">
                                            <div className="slider-contain">
                                                <div>
                                                    ...
                                                    <Link to={`${process.env.PUBLIC_URL}/product/oatmeal-soap`} className="btn btn-solid">Oatmeal Coconut Cream Soap</Link>
                                                </div>
                    ...
                    <Link to={`${process.env.PUBLIC_URL}/product/neem-soap`}>
                        <div>
                                        ...
                                        <div className="col">
                                            <div className="slider-contain">
                                                <div>
                                                    {/* <h4>welcome to fashion</h4> */}
                                                    {/* <h4>Home made creams</h4> */}
                                                    <Link to={`${process.env.PUBLIC_URL}/product/neem-soap`} className="btn btn-solid">Neem Soap</Link>
                                                </div>
