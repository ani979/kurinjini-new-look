					...
					<ScrollContext>
                        <Layout>
                            <Switch>
								...
								<Route path={`${process.env.PUBLIC_URL}/facemask`} render={(props) => <CollectionAll {...props} typeSelection = {allProducts.skin} mainSelection = {allProducts.faceCare} subSelection={allProducts.faceMask} />}/>
