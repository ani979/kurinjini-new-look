					...
					<ScrollContext>
                        <Layout>
                            <Switch>
								...
								<Route path={`${process.env.PUBLIC_URL}/moisturizing-creams`} render={(props) => <CollectionAll {...props} typeSelection = {allProducts.skin} subSelection={allProducts.moisturizingCreams} key = {allProducts.skin + allProducts.faceCare + allProducts.moisturizingCreams}/>}/>
								...
								<Route path={`${process.env.PUBLIC_URL}/spf-creams`} render={(props) => <CollectionAll {...props} typeSelection = {allProducts.skin} subSelection={allProducts.sunProtection} />}/>
								<Route path={`${process.env.PUBLIC_URL}/facecleansers`} render={(props) => <CollectionAll {...props} typeSelection = {allProducts.skin} mainSelection = {allProducts.faceCare} subSelection={allProducts.faceCleansers} />}/>
								...
								<Route path={`${process.env.PUBLIC_URL}/body-scrubbers`} render={(props) => <CollectionAll {...props} typeSelection = {allProducts.skin} mainSelection = {allProducts.scrubbing} subSelection={allProducts.soaps} />}/>
