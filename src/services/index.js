...
export const getSolutionFor = (products) => {
    var uniqueBrands = [];
...
export const getGoodFor = (products) => {
    var uniqueGoodness = [];
    
    products.map((product, index) =>
        
             product.goodFor?product.goodFor.map((goodFor) =>
            {
...
export const getVisibleproducts = (data, { tags, goodFor, value, sortBy, startPrice, endPrice }) => {
